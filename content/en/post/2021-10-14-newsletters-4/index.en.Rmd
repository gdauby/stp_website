...
projects: []
slug: []
subtitle: \vspace{-0.2cm} October 2021 \vspace{-0.6cm}
summary: ''
tags: []
...
```{r, echo=F, out.width='55%', fig.align="center", fig.cap="The team that went to the Pico in September 2021"}
# if(doc.type=="local_rmd") knitr::include_graphics("D:/MonDossierR/stp_website_backup//static/img/team_pico.jpg")
if(doc.type=="blog") knitr::include_graphics("D:/MonDossierR/stp_website_backup//static/img/img/team_pico.jpg")
```
...
```{r, echo=F, out.width='70%', fig.align="center", fig.cap="Increase in number of collections (for São Tomé, Príncipe and Annobon separately) and species since 1850, highlighting the inventories conducted during the project"}
