...
```{r, echo=F, fig.cap=" Mapa dos transectos estabelecidos no Príncipe."}
...
```{r, echo=F, out.width='80%', fig.align="center", fig.cap="Mapa dos transectos estabelecidos no São Tomé."}
