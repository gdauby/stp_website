...
categories: []
projects: []
slug: newsletters-from-the-field-august-pt
...
Já temos um Logo-tipo oficial para o Projecto Flora Ameaçada de São Tomé e Príncipe, criado por Victor Jiménez. Representa esquematicamente as duas ilhas como folhas. Para mais informações sobre o projecto, convidamos a visitar o nosso [website](https://cepf-stp-threat-flora.netlify.app/).


```{r ,include=TRUE, out.width='20%', echo=F, fig.align="center"}
if(doc.type=="local_rmd") knitr::include_graphics("D:/MonDossierR/stp_website/static/img/logo_proj.png")
```
...
Desde o ano passado, a equipa realizou 5 transectos e fez colheitas gerais em 16 localidades, recolhendo mais de 300 números de exemplars de herbário, apesar da pandemia do Covid 19. A equipa estabeleceu ainda um pequeno viveiro com 6 espécies de árvores, em cumprimento da nossa iniciativa de conservação ex-situ de espécies. No mapa abaixo, estão localizados os transectos recentemente realizados na ilha do Príncipe. The map below show the locations of the newly-established transects on Príncipe.


```{r, echo=F}

if(doc.type=="local_rmd")
transefts_lf_P
